			...
			<div class="col">
				<div class="card shadow">
					...
					<div class="container" style="margin-top: 10px">
						...
						$sql = "INSERT INTO `cliente`(`nome_cliente`, `sobrenome_cliente`, `endereco_cliente`, `nro_end_cliente`, `complemento`, `bairro_cliente`, `cidade_cliente`,`uf_cliente`, `cep_cliente`, `mail_cliente`, `cpf_cliente`, `interesse_cliente`) VALUES ('$nome','$sobrenome','$end',$nro,'$complemento','$bairro','$cidade','$estado','$cep','$email','$cpf','$interesse')";
