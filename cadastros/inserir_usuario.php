			...
			<div class="col">
				<div class="card shadow">
					<div class="card-header border-1">
						<h3 class="mb-0">Status Cadastro do Usuario</h3>
					</div>
					...
					<div class="container" style="margin-top: 10px">
						...
						$sql = "INSERT INTO `usuario`(`nome_usuario`, `nivel_acesso_usuario`, `mail_usuario`, `usuario`, `senha_usuario`) VALUES ('$nome',$nivel,'$mail','$usuario',md5('$senha'))";
